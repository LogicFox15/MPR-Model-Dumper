...
/// <summary>
/// This file is just so I have a placce to shove this massive crap
/// </summary>

public enum EGOComponentType : uint
{
...
public enum ETypedefInterfaceType : uint
{
    // Complex
...
public enum EGOPropertyType : uint
{
    ModConID = 0xa8e2ba93,
    ActorGenericStaticModelVisualID = 0xcb1c52f6,
    ActorGenericCharacterVisualData = 0x54446d42,       // used to store CHPR on ActorMP1 specifically
    PlatformMP1StaticModelVisualID = 0xf8b4c8da,
    DoorMP1VisualData = 0x275a54bd,

    RoomControllerID = 0x30a4d63d,

    // Skybox Hashes
    SkyboxModel = 0x387bb786,
    SkyboxStrength = 0x63328a04,

    VolumetricFogFloat1 = 0xf259966e,
    VolumetricFogFloat2 = 0x33cd9d58,
    VolumetricFogFloat3 = 0x9c1e9f8f,
    VolumetricFogFloat4 = 0xbf9b3481,
    VolumetricFogColor1 = 0xdac710d4,
    ...
    VolumetricFogRegionFar = 0xbaf7ac02,
    VolumetricFogRegionNear = 0xd1fc0ce8,
    VolumetricFogRegionColor = 0xc35e3f33,
    VolumetricFogRegionUnk1 = 0x671bb146,

    // Static Light Hashes
    LightStaticUnkBool1 = 0xf10ea1b7,
    LightStaticCastShadows = 0x163bbc26,
    LightStaticType = 0x52d4c579,
    LightStaticVisualData = 0xa35b13e6,
    LightStaticVisualID = 0x69602b8a,
    LightStaticDistAttenContainer = 0xebae52b2,
    LightStaticDistAttenType = 0x174c8abc,
    LightStaticAngleAttenContainer = 0x664b1a7c,
    LightStaticAngleAttenX = 0xb0a71764,
    LightStaticLightColorContainer = 0x8b76d48e,
    LightStaticLightColor = 0x8f421907,
    LightStaticLumaIntensityContainer = 0xdd21d666,
    LightStaticLumaIntensity = 0xdaf8bddf,
    LightStaticReflProbeInfluenceContainer = 0x21f525ea,
    LightStaticReflProbeInfluence = 0x21ae6030,
    LightStaticLightFlagsContainer = 0xf939c307,
    LightStaticLightFlagsA = 0xa160d6f5,

    // Dynamic Light Hashes
    LightDynamicType = 0x932dd7d8,
    LightDynamicLumaIntensity = 0xdf8c3909,
    LightDynamicLightColorContainer = 0xc3d93eb7,
    LightDynamicReflProbeInfluenceContainer = 0x4440e44c,
    LightDynamicReflProbeInfluence = 0xdd24b4b2,

    // Back Light Hashes
    BacklightDataContainer = 0x2833c9d2,
    BacklightUnkInt = 0x8ab8df40,
    BacklightUnkBool = 0xea3e22c0,
    BacklightNear = 0x059e985d,
    BacklightFar = 0xaa1a5fd9,

    // Common CHPR Hashes
    CommonCharacterData = 0x988bf21a, // CHPR stuff
    CommonCharacterVisualID = 0xa589d885,
    CommonCharacter8bytes1 = 0xd6f0c0f0,
    CommonCharacter8bytes2 = 0x87c03a01,

    // Water Hashes
    WaterRenderVolumeModel = 0x736e5890,
    WaterRenderVolumeGroup1 = 0x54f39685,
    WaterRenderVolumeGroup1BoolA = 0xbf2c11db,
    WaterRenderVolumeGroup1BoolB = 0x54ad680d,
    WaterRenderVolumeGroup1BoolC = 0x1878894a,
    WaterRenderVolumeGroup2 = 0x30fbb790,
    WaterRenderVolumeGroup2FloatA = 0xd1edd7b5,
    WaterRenderVolumeGroup2FloatB = 0xabe1bacd,
    WaterRenderVolumeGroup2FloatC = 0xf6266364,
    WaterRenderVolumeGroup2FloatD = 0x4574de4f,
    WaterRenderVolumeGroup2FloatE = 0x921415eb,
    WaterRenderVolumeGroup3 = 0x0951bf3e,
    WaterRenderVolumeDataChunk = 0xd1e9d29d,
    WaterRenderVolumeDataIDA = 0xe8969fad,
    WaterRenderVolumeDataFloatB = 0x00c267c0,
    WaterRenderVolumeDataFloatC = 0x50c8ac86,
    WaterRenderVolumeDataNormalMapChunk = 0x03e33f4b,
    WaterRenderVolumeDataNormalMap = 0x90a143ef,
    WaterRenderVolumeColorDataChunk = 0x7982e07b,
    WaterRenderVolumeColorDataColor = 0x6f7355a3,
    WaterRenderVolumeColorDataFloat = 0x3b29e512,

    // Water Hashes
    LavaRenderVolumeModel = 0xcaf8e8c3,
    LavaRenderVolumeGroup1 = 0xeee67cd7,
    LavaRenderVolumeGroup1Float1 = 0x54c1ad83,
    LavaRenderVolumeGroup1Float2 = 0x8e9d06a4,
    LavaRenderVolumeGroup1Float3 = 0x851b5ca5,
    LavaRenderVolumeGroup1Float4 = 0xf8bed071,
    LavaRenderVolumeFloat1 = 0x82330004,
    LavaRenderVolumeFloat2 = 0x4b27a58d,
    LavaRenderVolumeFloat3 = 0x30a47f17,
    LavaRenderVolumeFloat4 = 0x4ec7028f,
    LavaRenderVolumeOptionalFloat1 = 0x36062e0f,
    LavaRenderVolumeOptionalFloat2 = 0xe7993ff7,

    PickupMP1VisualData = 0x19d911b1,

    // Enemy Hashes
    GunTurretMP1VisualData = 0x97e8da78,
    IntroBossMP1VisualData = 0x914fb969,
    SpankweedMP1VisualData = 0x5191febb,
    ThardusMP1VisualData = 0x1d7db2fe,
    AtomicAlphaMP1VisualData = 0x87323a75,
    AtomicBetaMP1VisualData = 0x99a2a9d2,


    // Metroid Prime 4

    HUDModelMP4LargeContainerA = 0x948d7f67,
    HUDModelMP4SubDataA = 0x6c507c77,
    HUDModelMP4SubDataB = 0x26be04fa,

    HUDModelMP4GUID1 = 0x4ed7ca3d,
